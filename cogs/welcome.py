...
class Welcome(commands.Cog):
    ...
    async def welcome(self, ctx, action=None, *, text=None):
        ...
        # ===== JOIN MESSAGE =====
            ...
            return await ctx.send("✅ Join message set")
        ...
        # ===== LEAVE MESSAGE =====
            ...
            return await ctx.send("✅ Leave message set")
        ...
        # ===== BOOST MESSAGE =====
            ...
            return await ctx.send("✅ Boost message set")
    ...
    async def on_member_join(self, member):
        ...
        if not data or not data["channel"] or not data["join"]:
            return
    ...
    async def on_member_remove(self, member):
        ...
        if not data or not data["channel"] or not data["leave"]:
            return
    ...
    async def on_member_update(self, before, after):
        ...
        if before.premium_since is None and after.premium_since is not None:
            ...
            if not data or not data["channel"] or not data["boost"]:
                return
